...
The goal of regexcite25 is to make regular expressions more exciting!
...
You can install the development version of regexcite25 from [GitHub](https://github.com/) with:
